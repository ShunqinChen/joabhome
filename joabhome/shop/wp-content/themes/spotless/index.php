...
<?php previous_post('%', '&laquo; Previous &middot;', 'no'); ?> <?php next_posts_link('&laquo; Previous &middot;') ?> <a href="<?php the_permalink() ?>" title="Permalink"><?php the_title(); ?></a> &middot; <?php comments_popup_link(__('Comments (0)'), __('Comments (1)'), __('Comments (%)')); ?> <?php previous_posts_link('&middot; Next &raquo;') ?> <?php next_post('%', '&middot; Next &raquo;', 'no'); ?>   	 
</div>   

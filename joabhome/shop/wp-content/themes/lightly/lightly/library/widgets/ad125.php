 ...
 *
 */
class WP_Widget_Links_Ad125_Plus62 extends WP_Widget {

	function __construct() {
		$widget_ops = array('classname'=>'widget_ad125', 'description' => __( "Ads 125, To manage the advertisement, please use the Link Manager (Dashboard->Links) don't forget to set the image field with 125 px width image link, see documentation for more information." ) );
		parent::__construct('ad125', __('Plus62 - Ads 125'), $widget_ops);
	}
...
add_action('widgets_init', create_function('', 'return register_widget("WP_Widget_Links_Ad125_Plus62");'));
